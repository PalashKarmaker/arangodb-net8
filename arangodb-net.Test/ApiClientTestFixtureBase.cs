using ArangoDBNet;
using ArangoDBNet.AdminApi.Models;
...
public abstract class ApiClientTestFixtureBase : IDisposable, IAsyncLifetime
{
    ...
    private readonly List<HttpApiTransport> _transports = [];
    ...
    public static string ArangoDbHost => Environment.GetEnvironmentVariable("ARANGO_HOST") ?? "localhost";

    public static int ArangoDbPort => int.TryParse(
