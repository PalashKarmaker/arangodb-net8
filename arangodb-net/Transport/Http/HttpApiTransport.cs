    ...
    bool suppressClientDisposal = false) : IApiClientTransport
{
    ...
    public void UseJsonContentType()
    {
        ...
        client.DefaultRequestHeaders.Accept.Add(
            new MediaTypeWithQualityHeaderValue(_contentTypeMap[contentType]));
    }
    ...
    {
        contentType = HttpContentType.VPack;
        client.DefaultRequestHeaders.Accept.Clear();
        client.DefaultRequestHeaders.Accept.Add(
            new MediaTypeWithQualityHeaderValue(_contentTypeMap[contentType]));
    }
        ...
        CancellationToken token = default)
    {
        ...
        request.Content.Headers.ContentType = new MediaTypeHeaderValue(_contentTypeMap[contentType]);
        ...
        CancellationToken token = default)
    {
        ...
        httpContent.Headers.ContentType = new MediaTypeHeaderValue(_contentTypeMap[contentType]);
